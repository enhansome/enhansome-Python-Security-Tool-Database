...
* [Metasploit](https://github.com/rapid7/metasploit-framework) ⭐ 38,879 | 🐛 593 | 🌐 Ruby | 📅 2026-08-25 - Alright so this thing isn't even close to being mostly Python, but cmon it's Metasploit. This has to be in here because I love this thing so much. This makes my life easier every single day.

##### Adversary Simulation

* [Caldera](https://github.com/mitre/caldera) ⭐ 7,213 | 🐛 75 | 🌐 Python | 📅 2026-08-12 - Mitre's adversary emulation tool. It's not entirely python, but it's mostly python and so sick that it has to be included here.
...
* [Splunk Attack Data](https://github.com/splunk/attack_data) ⭐ 807 | 🐛 4 | 🌐 Python | 📅 2026-08-25 - Allows you to replay attacks generated from logs, lots of datasets to chose from have already been included in the repo.
...
* [Malware CAPE](https://github.com/kevoreilly/CAPEv2) ⭐ 3,447 | 🐛 55 | 🌐 Python | 📅 2026-08-23 - This is the Malware Configuration and Payload Extractor, hence the name CAPE. It's phenomenal and there's an [online instance](https://capesandbox.com/).
...
* [sherlock](https://github.com/sherlock-project/sherlock) ⭐ 90,318 | 🐛 333 | 🌐 Python | 📅 2026-08-25 - Best broad social media hunter I've used by far. So simple a caveman could do it.
* [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 21,420 | 🐛 311 | 🌐 Python | 📅 2026-04-13 - Easily the coolest OSINT tool on the list, it would be first if I wasn't trying to keep this thing alphabetical. Its perks are too numerous to outline here, go to their page.
* [theHarvester](https://github.com/laramies/theHarvester) ⭐ 17,196 | 🐛 8 | 🌐 Python | 📅 2026-08-26 - Jack of Most Trades OSINT tool maintained by a bunch of people. Often Updated and might as well be a household name. It's well-rounded and efficient. What more could you ask for?
* [holehe](https://github.com/megadose/holehe) ⭐ 14,227 | 🐛 114 | 🌐 Python | 📅 2024-09-10 - Simple mail checker for popular websites. Clean and to the point, updated by [megadose](https://twitter.com/palenath) as needed. They also have a lot of other interesting projects.
* [Osintgram](https://github.com/Datalux/Osintgram) ⭐ 14,134 | 🐛 883 | 🌐 Python | 📅 2025-08-25 - Instagram is a wealth of data for those that look, it's maintained by a lot of folks, but Instagram changes may break functionality. It's a well organized project and lots of forks to take a look at.
* [BlackBird](https://github.com/p1ngul1n0/blackbird) ⭐ 7,853 | 🐛 19 | 🌐 Python | 📅 2025-07-13 - Another OSINT tool! I seem to have a favorite category at this point.
* [Recon-ng](https://github.com/lanmaster53/recon-ng) ⭐ 5,871 | 🐛 38 | 🌐 Python | 📅 2024-11-01 - The OSINT equivalent to the Metasploit Framework. Could be updated more often, but it's well respected and there's decades of content on the internet to help you get familiar with it.
* [IntelOwl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,682 | 🐛 78 | 🌐 Python | 📅 2026-08-25 - It's a cool malware/malspam threat intel tool. It's mostly Python, but it's pretty JS heavy. I've used it and my thoughts on it are: "Clean/Functional/Well Documented, but it smells like a corporate project."
...
* [NetworkX](https://github.com/networkx/networkx) ⭐ 17,220 | 🐛 324 | 🌐 Python | 📅 2026-08-21 - Incredibly thourough network mapping and analysis tool for small and large networks.
* [Impacket](https://github.com/fortra/impacket) ⭐ 16,037 | 🐛 314 | 🌐 Python | 📅 2026-08-24 - Impacket is a flexible toolkit for crafting, manipulating, and analyzing network protocols. Never leave home without it.
* [Scapy](https://github.com/secdev/scapy) ⭐ 12,501 | 🐛 134 | 🌐 Python | 📅 2026-08-25 - Python packet manipulation tool for a really solid number of protocols.
...
* [SQL Map](https://github.com/sqlmapproject/sqlmap) ⭐ 38,266 | 🐛 33 | 🌐 Python | 📅 2026-08-23 - This thing is so cool! Really awesome set of contributors on this project, basically it's an automated detector/exploiter for SQL injection vulnerabilities. This thing kicks ass once you get the hang of it.
...
* [BetterCAP](https://github.com/bettercap/bettercap) ⭐ 19,858 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - BetterCAP is a powerful, flexible, and portable tool designed for performing various types of MITM attacks against networks along with general network recon.
