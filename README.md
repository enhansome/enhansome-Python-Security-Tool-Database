...
* [Malware CAPE](https://github.com/kevoreilly/CAPEv2) ⭐ 3,445 | 🐛 56 | 🌐 Python | 📅 2026-08-23 - This is the Malware Configuration and Payload Extractor, hence the name CAPE. It's phenomenal and there's an [online instance](https://capesandbox.com/).
...
* [Metagoofil](https://github.com/laramies/metagoofil) ⭐ 1,312 | 🐛 19 | 🌐 Python | 📅 2024-03-21 - This is an oldie, but a goodie from the days of Python 2. This tool helps obtain files and metadata from target websites using Google.
...
* [SQL Map](https://github.com/sqlmapproject/sqlmap) ⭐ 38,258 | 🐛 32 | 🌐 Python | 📅 2026-08-23 - This thing is so cool! Really awesome set of contributors on this project, basically it's an automated detector/exploiter for SQL injection vulnerabilities. This thing kicks ass once you get the hang of it.
