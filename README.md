...
* [Metasploit](https://github.com/rapid7/metasploit-framework) ⭐ 38,852 | 🐛 610 | 🌐 Ruby | 📅 2026-08-24 - Alright so this thing isn't even close to being mostly Python, but cmon it's Metasploit. This has to be in here because I love this thing so much. This makes my life easier every single day.
...
* [Malware CAPE](https://github.com/kevoreilly/CAPEv2) ⭐ 3,441 | 🐛 56 | 🌐 Python | 📅 2026-08-23 - This is the Malware Configuration and Payload Extractor, hence the name CAPE. It's phenomenal and there's an [online instance](https://capesandbox.com/).
...
* [sherlock](https://github.com/sherlock-project/sherlock) ⭐ 90,097 | 🐛 333 | 🌐 Python | 📅 2026-08-23 - Best broad social media hunter I've used by far. So simple a caveman could do it.
* [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 21,377 | 🐛 310 | 🌐 Python | 📅 2026-04-13 - Easily the coolest OSINT tool on the list, it would be first if I wasn't trying to keep this thing alphabetical. Its perks are too numerous to outline here, go to their page.
* [theHarvester](https://github.com/laramies/theHarvester) ⭐ 17,176 | 🐛 7 | 🌐 Python | 📅 2026-08-24 - Jack of Most Trades OSINT tool maintained by a bunch of people. Often Updated and might as well be a household name. It's well-rounded and efficient. What more could you ask for?
* [Osintgram](https://github.com/Datalux/Osintgram) ⭐ 14,097 | 🐛 883 | 🌐 Python | 📅 2025-08-25 - Instagram is a wealth of data for those that look, it's maintained by a lot of folks, but Instagram changes may break functionality. It's a well organized project and lots of forks to take a look at.
* [holehe](https://github.com/megadose/holehe) ⭐ 14,078 | 🐛 113 | 🌐 Python | 📅 2024-09-10 - Simple mail checker for popular websites. Clean and to the point, updated by [megadose](https://twitter.com/palenath) as needed. They also have a lot of other interesting projects.
* [BlackBird](https://github.com/p1ngul1n0/blackbird) ⭐ 7,823 | 🐛 19 | 🌐 Python | 📅 2025-07-13 - Another OSINT tool! I seem to have a favorite category at this point.
...
* [IntelOwl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,680 | 🐛 74 | 🌐 Python | 📅 2026-08-20 - It's a cool malware/malspam threat intel tool. It's mostly Python, but it's pretty JS heavy. I've used it and my thoughts on it are: "Clean/Functional/Well Documented, but it smells like a corporate project."
...
* [NetworkX](https://github.com/networkx/networkx) ⭐ 17,217 | 🐛 323 | 🌐 Python | 📅 2026-08-21 - Incredibly thourough network mapping and analysis tool for small and large networks.
* [Impacket](https://github.com/fortra/impacket) ⭐ 16,028 | 🐛 313 | 🌐 Python | 📅 2026-08-19 - Impacket is a flexible toolkit for crafting, manipulating, and analyzing network protocols. Never leave home without it.
...
* [SQL Map](https://github.com/sqlmapproject/sqlmap) ⭐ 38,250 | 🐛 32 | 🌐 Python | 📅 2026-08-23 - This thing is so cool! Really awesome set of contributors on this project, basically it's an automated detector/exploiter for SQL injection vulnerabilities. This thing kicks ass once you get the hang of it.
...
* [BetterCAP](https://github.com/bettercap/bettercap) ⭐ 19,849 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - BetterCAP is a powerful, flexible, and portable tool designed for performing various types of MITM attacks against networks along with general network recon.
